...
var zombieImg2;
var zombieImg3,zombieImg4;
var zombieImg5,zombieImg6;
...
function preload(){
  ...
  zombieImg2 = loadImage("assets/zombie2.webp")
  zombieImg3 = loadImage("assets/zombie3.webp")
  zombieImg4 = loadImage("assets/zombie4.png")
  zombieImg5 = loadImage("assets/zombie5.png")
  zombieImg6 = loadImage("assets/zombie6.png")
...
function doStart(){
  textSize(40);
  fill("red");
  text("Welcome to zombie world ",470,410);
  text("Rules/Instructions:-- 1.Press Space button to shoot zombies",370,450);
  text("Rules/Instructions:-- 2.Press Up,Down,Left and Right button to move",360,490);
  text("Press P to start the game and kill zombies to save yourself",370,530);
}
